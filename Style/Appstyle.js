...
export default StyleSheet.create({
  ...
  rect: {
    backgroundColor: '#ccc', // Background color for the note box
    padding: 10,
    marginVertical: 10,
    borderRadius: 10, // Adjusted borderRadius for round corners
    width: width-20, // Adjusted width for a square box
    flexDirection: 'row', // Added flexDirection to position buttons horizontally
    justifyContent: 'space-between', // Added justifyContent to push buttons to the right
    alignItems: 'center',
  }
